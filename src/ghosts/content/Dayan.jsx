  ...
  return (
    <div className='desc-block'>
      <div>
        ...
        <div className='desc-content'>當任意玩家距離達彥 10 米以內時，鬼魂的獵殺理智閾值與獵殺速度會根據最近的玩家產生變化。</div>
        <div className='desc-content'>若該玩家 <hl>靜止不動</hl>，獵殺閾值降至 45%，鬼魂速度固定為 1.2。</div>
        <div className='desc-content'>若該玩家 <hl>正在移動</hl>，獵殺閾值升至 65%，鬼魂速度固定為 2.25。</div>

        <div className='desc-contnet'>沒有玩家在達彥 10 米範圍內時，鬼魂恢復標準獵殺閾值 50%，並遵循標準鬼魂速度 1.7，並具有視野加速。</div>
        <br />
        <div className='desc-content'>※ <hl>檢測到玩家移動並不代表獲知玩家位置。</hl></div>
      </div>
      <div>
